...
def generate_launch_description():
    ...
    # Define launch actions for Gazebo server and client
    # We explicitly launch gzserver and gzclient separately to avoid issues with 
    # ThisLaunchFileDir() in the standard gazebo.launch.py when running in this context.
